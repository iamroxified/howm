                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('topic_id') is-invalid @enderror" id="topic_id" name="topic_id">
                        ...
                        @foreach ($topics as $topic)
                            <option value="{{ $topic->id }}" {{ (isset($selectedTopic) && $selectedTopic == $topic->id) || old('topic_id') == $topic->id ? 'selected' : '' }}>{{ $topic->topic }}</option>
                        @endforeach
                    </select>
                    @error('topic_id')
                        <div class="invalid-feedback">{{ $message }}</div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('project_cost') is-invalid @enderror" id="project_cost" name="project_cost" value="{{ old('project_cost') }}">
                    @error('project_cost')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="balance" name="balance" value="{{ old('balance') }}" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('supervisor_fee') is-invalid @enderror" id="supervisor_fee" name="supervisor_fee" value="{{ old('supervisor_fee') }}">
             ...
             <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('amt_paid_to_supervisor') is-invalid @enderror" id="amt_paid_to_supervisor" name="amt_paid_to_supervisor" value="{{ old('amt_paid_to_supervisor') }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('developer_fee') is-invalid @enderror" id="developer_fee" name="developer_fee" value="{{ old('developer_fee') }}" readonly>
                    @error('developer_fee')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('amt_paid_to_developer') is-invalid @enderror" id="amt_paid_to_developer" name="amt_paid_to_developer" value="{{ old('amt_paid_to_developer') }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Initial calculation on page load in case of old input
